...
(function(process) {
      ...
      (function(p) {
        ...
        a.a = function() {
          ...
          var l = {propertychange: !0},
              g = w && function() {
                for (var a = 3,
                    ...
                    c = b.getElementsByTagName("i"); b.innerHTML = "\x3c!--[if gt IE " + ++a + "]><i></i><![endif]--\x3e", c[0]; )
                  ;
                return 4 < a ? a : p;
              }(),
              m = /\S+/g;
          return {
            ...
            Jb: function(b) {
              b = a.a.O(b);
              for (var c = (b[0] && b[0].ownerDocument || w).createElement("div"),
                  g = 0,
                  d = b.length; g < d; g++)
            ...
            M: g,
            Db: function(b, c) {
              for (var g = a.a.O(b.getElementsByTagName("input")).concat(a.a.O(b.getElementsByTagName("textarea"))),
          ...
          a.a.gb = function(b, d) {
            ...
            if (null !== d && d !== p)
              if ("string" != typeof d && (d = d.toString()), u)
                ...
                for (var c = a.a.ca(d, b.ownerDocument),
                    e = 0; e < c.length; e++)
                  b.appendChild(c[e]);
          };
        })();
        ...
        a.ba.fn = {
          remove: function(b) {
            for (var d = this.B(),
                c = [],
                e = "function" != typeof b || a.F(b) ? function(a) {
                  return a === b;
                } : b,
                f = 0; f < d.length; f++) {
              var k = d[f];
 ...
 while (m = m.nextSibling);
        ...
        (function(b) {
          ...
          var e = 0;
          a.d.component = {init: function(f, k, h, l, g) {
              function m() {
                var a = x && x.dispose;
        ...
        a.d.event = {init: function(b, d, c, e, f) {
            var k = d() || {};
            a.a.A(k, function(h) {
        ...
        a.d.submit = {init: function(b, d, c, e, f) {
        ...
        (function() {
          ...
          a.d.textInput = {init: function(b, c, l) {
              function h(c, d) {
                a.a.n(b, c, d);
              }
              function k() {
